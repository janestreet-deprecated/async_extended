(* OASIS_START *)
(* DO NOT EDIT (digest: d0f34c433e24f91cf9eb39e23e72e902) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_extended";
          synopsis = "Additional utilities for async";
          description =
            Some
              [
                 OASISText.Para
                   "Async_extended is a collection of utilities for async. They don't get the same level of review compared to other packages of the core suite but they might still be useful."
              ];
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "async_extended"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "find.ml"});
               Executable
                 ({
                     cs_name = "pause";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "async_extended"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "pause.ml"});
               Executable
                 ({
                     cs_name = "primes";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "primes.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "v\208r\207\193\175\132\133\217\193\002\173f=iQ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
